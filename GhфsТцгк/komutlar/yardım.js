...
//GENEL KOMUTU
  ...
  .setFooter('Bu komutu kullanan kullanıcı ' + message.author.tag, message.author.displayAvatarURL())
   .setDescription(client.commands.filter(cmd => cmd.conf.kategori === 'Genel').map(cmd => `:white_small_square: - **${prefix}${cmd.help.name}** ${cmd.help.description}`).join("\n "))
        .addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=941466963425755136&scope=bot&permissions=2108157183)` + "** | **" + `[Destek Sunucusu](https://discord.gg/GShZthH9gj)`  + "** | **" + `[Oy Ver](https://top.gg/bot/941466963425755136)  `, false)
...
//YARDIM KOMUTU
  ...
  ** [${prefix}Yardım Sunucu](https://discord.gg/GShZthH9gj)**
  ** ${prefix}Yardım Sahip **
  `)
  .addField("» Linkler", ` [Davet Et](https://discord.com/oauth2/authorize?client_id=941466963425755136&scope=bot&permissions=2108157183)` + "** | **" + `[Destek Sunucusu](https://discord.gg/GShZthH9gj)`  + "** | **" + `[Oy Ver](https://top.gg/bot/941466963425755136)  `, false)
...
//KADİRCAN GÜLTEKİN TARAFINDAN YAPILMIŞTIR 2021 DE YENİLENMİŞTİR!
